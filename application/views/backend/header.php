...
<html lang="en">
<head>
<title>WinOneDollar Admin</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="#">WinOneDollar Admin</a></h1>
</div>
<!--close-Header-part-->
        ...
        <li class="divider"></li>
          ...
          <?php
            ...
            if( isset( $auth_user_id ) ){
              echo "<li><a href='".base_url()."login/logout/admin'><i class='icon-key'></i> Log Out</a></li>";
            }
          ?>
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-info-sign"></i> Error</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-user"></i> <span>Users</span> </a>
      <ul>
        <li><a href="<?php echo base_url(); ?>dashboard/users/insert-user">Add New User</a></li>
        <li><a href="<?php echo base_url();?>dashboard/users/manage-user">Manage Users</a></li>
        <li><a href="<?php echo base_url();?>dashboard/users/change-password">Password Change</a></li>
      </ul>
    </li>
